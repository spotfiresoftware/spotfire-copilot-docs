...
- **`dv` MCP server** — the agent's tools call this MCP server at runtime. See [DV MCP server deployment guide](../MCP%20Servers/Spotfire%20Copilot%20-%20Data%20Virtualization%20%28DV%29%20MCP%20Server%20Deployment%20Guide.md).
