...
- **`spotfire-lib` MCP server** — the agent's tools call this MCP server at runtime. See [Spotfire Library MCP server deployment guide](../MCP%20Servers/Spotfire%20Copilot%20-%20Spotfire%20Library%20MCP%20Server%20Deployment%20Guide.md).
