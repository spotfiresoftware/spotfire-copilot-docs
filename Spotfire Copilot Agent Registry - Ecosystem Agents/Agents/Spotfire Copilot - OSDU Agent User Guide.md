...
- **`osdu` MCP server** — the agent's tools call this MCP server at runtime. See [OSDU MCP server deployment guide](../MCP%20Servers/Spotfire%20Copilot%20-%20OSDU%20MCP%20Server%20Deployment%20Guide.md).
