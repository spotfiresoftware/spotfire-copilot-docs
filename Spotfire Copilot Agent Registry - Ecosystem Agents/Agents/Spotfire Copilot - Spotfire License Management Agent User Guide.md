...
- **`spotfire-lic` MCP server** — the agent's tools call this MCP server at runtime. See the [Spotfire License MCP server user guide](../mcp-servers/spotfire-license/Spotfire%20Copilot%20-%20Spotfire%20License%20MCP%20Server%20User%20Guide.md) and [deployment guide](../mcp-servers/spotfire-license/Spotfire%20Copilot%20-%20Spotfire%20License%20MCP%20Server%20Deployment%20Guide.md).
