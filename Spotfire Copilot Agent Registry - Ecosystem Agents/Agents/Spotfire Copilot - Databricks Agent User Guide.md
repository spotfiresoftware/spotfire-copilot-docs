...
- **`databricks` MCP server** — the agent's tools call this MCP server at runtime. See [Databricks MCP server deployment guide](../MCP%20Servers/Spotfire%20Copilot%20-%20Databricks%20MCP%20Server%20Deployment%20Guide.md).
