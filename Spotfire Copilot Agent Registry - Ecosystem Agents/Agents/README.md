...
End-user guides for the A2A agents hosted by the [Agent Server Deployment](../agent-server-deployment/README.md) (a LangGraph DeepAgents server). Each agent depends on a backing [MCP server](../mcp-servers/README.md); both the agent server and the agent's MCP server must be reachable before the agent can be invoked from the Spotfire Copilot Panel.
...
| [Databricks Agent](Spotfire%20Copilot%20-%20Databricks%20Agent%20User%20Guide.md) | Explores Unity Catalog metadata, traces table lineage, and runs SQL against Databricks. | [Databricks MCP Server](../mcp-servers/databricks/Spotfire%20Copilot%20-%20Databricks%20MCP%20Server%20User%20Guide.md) |
...
| [Spotfire Library Metadata Agent](Spotfire%20Copilot%20-%20Spotfire%20Library%20Metadata%20Agent%20User%20Guide.md) | Browses a Spotfire Server library: discovers items of any kind (DXPs, data connections, information links, data functions, and more), returns item metadata, and lists an item's children. | [Spotfire Library MCP Server](../mcp-servers/spotfire-library/Spotfire%20Copilot%20-%20Spotfire%20Library%20MCP%20Server%20User%20Guide.md) |
| [Spotfire License Management Agent](Spotfire%20Copilot%20-%20Spotfire%20License%20Management%20Agent%20User%20Guide.md) | Inspects the Spotfire license catalog and entitlements, and assigns or revokes group licenses. | [Spotfire License MCP Server](../mcp-servers/spotfire-license/Spotfire%20Copilot%20-%20Spotfire%20License%20MCP%20Server%20User%20Guide.md) |
| [Tavily Web Search Agent](Spotfire%20Copilot%20-%20Tavily%20Web%20Search%20Agent%20User%20Guide.md) | AI-powered web research: general search, direct-answer search with citations, and recent news. | [Tavily MCP Server](../mcp-servers/tavily/Spotfire%20Copilot%20-%20Tavily%20MCP%20Server%20User%20Guide.md) |
